...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        # muda o titulo que aprece no topo da janela
        self.setWindowTitle('Calculadora do Willian')
        # Trava o tamanho da tela em um valor pré-definido
        ...
        self.display.setStyleSheet(
            '* {backgroud: #FFF; color: #000; font-size: 30px}'
        )
